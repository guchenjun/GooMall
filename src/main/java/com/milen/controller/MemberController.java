...
public class MemberController {
    ...
    public String memberOrder(@PathVariable(value = "pageNum", required = false) Integer pageNum,
        ...
        int pageSize = 4;
        Page<TradeOrderVO> page = PageHelper.startPage(pageNum, pageSize);
        List<TradeOrderVO> tradeOrderVOList = tradeService.listTradeOrderByUserId(user.getId());
        PageInfo<TradeOrderVO> pageVO = new PageInfo<>(page.getResult());
